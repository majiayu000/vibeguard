...
if [[ $# -eq 6 && "$1" == "--test-only" ]]; then
  ...
  unset VG_INTERNAL_CONFIG_FILE VIBEGUARD_CONFIG_FILE VG_INTERNAL_USER_CONFIG_FILE VIBEGUARD_USER_CONFIG_FILE VIBEGUARD_PROJECT_CONFIG
  unset VG_INTERNAL_POLICY_CWD VIBEGUARD_POLICY_CWD VIBEGUARD_PROJECT_ROOT VIBEGUARD_PROJECT_CWD VIBEGUARD_LOG_DIR
fi
