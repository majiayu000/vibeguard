...
assert_contains "${behavior_out}" "claude=3/3" "behavior report includes Claude platform slice"
assert_contains "${behavior_out}" "codex=3/3" "behavior report includes Codex platform slice"
