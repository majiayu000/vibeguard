...
receipts 齐备后先在 bounded global source registry fsync inert route/body/barrier/eligibility，worker
仍须验证 exact barrier；随后 barrier + registration durable 才能 done。reconcile policy 必须先
