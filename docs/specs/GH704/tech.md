...
```json
{
  ...
  "spec_refs": [
    ...
    "docs/specs/GH704/integrity_retention_model.json",
    "docs/specs/GH704/integrity_retention_model.schema.json",
    "docs/specs/GH704/verify_integrity_retention_model.py",
    "docs/specs/GH704/resource_ledger_model.json",
    "docs/specs/GH704/resource_ledger_model.schema.json",
    "docs/specs/GH704/verify_resource_ledger_model.py",
    "docs/specs/GH704/json_schema_subset.py",
    "docs/specs/GH704/resource_ledger_epoch.py"
  ]
}
```
