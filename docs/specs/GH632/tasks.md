...
- [ ] `SP632-T1` 补齐 directory map 的 operational script groups。Covers: B-001. Owner: implementation agent. Dependencies: spec approval. Done when: 五个当前一级目录有简洁职责说明。Verify: inventory/map focused assertion。
