...
publication 使用 attempt-scoped draft 与一个统一 durable state machine；完整 canonical secret/history contract只引用 [publication_history_contract.md](publication_history_contract.md)：
