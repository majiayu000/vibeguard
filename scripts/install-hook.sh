...
echo "Adjust guard timeout: VIBEGUARD_PRECOMMIT_TIMEOUT=15 git commit -m \"msg\""
echo "Adjust build timeout: VIBEGUARD_PRECOMMIT_BUILD_TIMEOUT=120 git commit -m \"msg\""
