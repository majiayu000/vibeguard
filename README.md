...
| AI tries to finish with unverified changes in `full` / `strict` profile | `stop-guard` | **Signal** — logs a Stop reminder; the Stop hook exits 0 to avoid feedback loops |
